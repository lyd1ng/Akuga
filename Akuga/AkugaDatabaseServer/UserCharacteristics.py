...
def register_user(communicator, client_address, cmd_queue,
...
def check_user_credentials(communicator, client_address,
...
def update_user(communicator, client_address, cmd_queue,
...
def set_jumon_set(communicator, client_address, cmd_queue,
...
def reward_user(communicator, client_address, cmd_queue, username, credits):
    """
    ...
    try:
        ...
        communicator.send_packet(["ERROR", "Insecure Parameter"])
        return -1
